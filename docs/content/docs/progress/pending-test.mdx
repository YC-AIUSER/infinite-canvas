...
- Toonflow 专用画布：画布库新增 Toonflow 生产画布入口，按三段布局自动创建项目/剧集、剧本、资产库、空间合同、分镜表、镜头合同、动作合同、故事板页、分镜图/首帧、过审、视频工作台、接缝检查、音频混音、成片/导出独立节点；Toonflow 模式下收起普通文本/图片/视频/音频/配置等通用创建入口，需人工确认节点布局、连线、刷新持久化和工具栏收口效果。
